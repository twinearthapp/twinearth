...
1. 🐦 **On X** — Vote in polls, share your dream route → [@TwinEarthApp](https://x.com/twinearthapp)
...
Use this code to heal, to explore, to connect.
...
- 📜 **[White Paper v1.8 (Full)](./WHITEPAPER.md)** — Philosophy, tech, roadmap, budget
- 🐦 **[X / Twitter](https://x.com/twinearthapp)** — Updates, polls, community voice
